...
import {DatagramMessage, ThreadControlMessage} from "../MsgMainToWorker";
import {DatagramDownstreamMessage, ThreadControlAckMessage, DatagramSignalSent} from "../MsgWorkerToMain";
